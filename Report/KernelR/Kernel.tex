...
To study how  the performance of the DTW algorithm is affected by new changes,  I tested this algorithm on 3 different types of data sets and compared 
it's performance against the following 4 models we discussed so far :
\begin{itemize}
\item Method 1
\begin{itemize}
