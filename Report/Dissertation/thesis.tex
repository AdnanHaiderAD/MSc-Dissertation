...
\begin{figure}[H]
  ...
  \end{figure}
Generally as a cost metric, the euclidean metric is mostly widely used to compare the values between the time.  For this project, I will hence consider the basic  DTW algorithm equipped with the euclidean metric as my baseline \textbf{DTW algorithm}. An outline of the base line  DTW algorithm is given below:
