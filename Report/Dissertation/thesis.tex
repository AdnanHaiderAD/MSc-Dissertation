...
\begin{figure}[h!]
  \centering
     ...
     \includegraphics[scale=0.8]{521.jpg}
  \caption{Accuracy}
...
\begin{figure}[H]
  \centering
     ...
     \includegraphics[scale=0.8]{522.jpg}
...
To check whether the new changes do in fact provide a better alternative to using rigid window constraint for  very long sequences, I repeat the same experiment again but this time, I replace the feature extraction method of 5.2 with the MFCC feature extraction. The objective here is to check whether these new changes do result in faster and improved version of DTW than the current version of DTW algorithm.
